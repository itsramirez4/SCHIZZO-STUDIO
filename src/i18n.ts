...
export const NAMESPACES = ['common', 'chrome', 'dialogs', 'tours', 'panelsProduction'] as const;
...
void i18n.use(initReactI18next).init({
  resources: {
    es: { common: esCommon, chrome: esChrome, dialogs: esDialogs, tours: esTours, panelsProduction: esPanelsProduction },
    en: { common: enCommon, chrome: enChrome, dialogs: enDialogs, tours: enTours, panelsProduction: enPanelsProduction },
  },
  lng: 'es',
  fallbackLng: 'es',
  ns: NAMESPACES,
