...
export const DOC_PAGES: DocPage[] = [
  ...
  },
  {
    ...
    content: [
      ...
      'Qué hace, y con qué medios: pose y expresión a partir de una descripción («mujer corriendo con los brazos hacia arriba», «muy sorprendido») que colocan el maniquí 3D. Es un intérprete de palabras clave en español con tolerancia a erratas (corrige «corrindo» → «corriendo» y te lo dice), y te indica qué entendió y qué ignoró. Para frases libres, si configuras una API compatible con OpenAI aparece «Entender frase libre»: se le envía solo tu frase para que la reescriba con las palabras que el intérprete conoce, y el intérprete sigue siendo quien la traduce a articulaciones. Convertir la pose de tu dibujo en el maniquí 3D: busca la figura (o usa tus puntos) y ajusta las articulaciones a la vista frontal. Un dibujo plano no dice si un brazo o una pierna acortados apuntan hacia ti o hacia atrás, así que puedes elegirlo por extremidad y reajustar; la inclinación del torso hacia la cámara no se deduce. Variaciones de iluminación: leen el brillo como relieve, iluminan desde otra dirección y proyectan las sombras de los relieves sobre lo que hay detrás; es una ayuda para estudiar dónde irían luces y sombras, no una simulación física ni entiende volúmenes que no se ven en el brillo. Análisis de anatomía y proporciones; paletas desde un texto o desde tus colores; consejos de composición con mapa de atención; limpieza de motas y huecos con vista previa; separación en capas (línea/color, sujeto/fondo, por colores; la capa de color rellena bajo la línea, también sobre fondos no blancos). Todo eso se calcula en tu equipo.',
